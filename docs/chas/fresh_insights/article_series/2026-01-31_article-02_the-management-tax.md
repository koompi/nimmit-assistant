...
You have just paid your first *management tax*.

### The Cost of a Conversation
Every time you add a person to a project, you create a new *link* that requires communication. This communication is not free. It takes time, energy, and focus.

Economists call this a *transaction cost*. 

Think about it this way: if you spend 1 hour preparing a set of instructions so that a freelancer can do 1 hour of work, the *friction* has canceled out the benefit. You have spent 2 hours of total effort to get 1 hour of results. 
...
3. Show them how to fix it.
4. Check it again later.
